//
//  SSQOrderBottomMultipleBarView.swift
//  Lottery
//
...
class SSQOrderBottomMultipleBarView: DPCOrderBottomMultipleBarView {

    override init(frame: CGRect) {
        super.init(frame: frame);
        self.mainView = SSQOrderBottomMultipleBarMainView(frame: CGRect(x: 0, y: 40, width: self.frame.width, height: 40));
